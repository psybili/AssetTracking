...
//        testList.value = TripTestUtil.listFinishedTrips()
//
//        Mockito.`when`(tripDao.listFinishedTrips()).thenReturn(testList)
//
//        val data = repository.getTrips()
//        Mockito.verify(tripDao).listFinishedTrips()
...
//        val testList = TripTestUtil.listFinishedTrips()
//
